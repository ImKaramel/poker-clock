...
import freezeout from "../assets/FREEZEOUT.jpg";
...
import three_cards_tournament from "../assets/THREE CARDS TOURNAMENT.jpg";
import mystery_bounty from "../assets/MYSTERY BOUNTY.jpg";
...
const TOURNAMENT_IMAGES_MAP: Record<string, string> = {
  ...
  "THREE CARDS": three_cards_tournament,
  "THREE CARDS TOURNAMENT": three_cards_tournament,
  "MYSTERY BOUNTY": mystery_bounty,
  "MYSTERY BOUNTY TOURNAMENT": mystery_bounty,
};
